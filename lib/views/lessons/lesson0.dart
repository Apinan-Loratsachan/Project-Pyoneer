...
class _Lesson0ScreenState extends State<Lesson0Screen> {
  ...
  Widget build(BuildContext context) {
    return LessonScreenModel(
      appBarTitle: LessonComponent.lessonContent[0].title,
      appBarSubTitle: LessonComponent.lessonContent[0].subTitle,
      coverImagePath: LessonComponent.lessonContent[0].imageSrc,
      heroTag: LessonComponent.lessonContent[0].heroTag,
      ...
      contentWidgets: [
        ...
        PyoneerText.contentText("นอกจากนี้ Python ยังมีชุมชนผู้ใช้ขนาดใหญ่และไลบรารีต่างๆ มากมายที่พร้อมใช้งาน ซึ่งทำให้การพัฒนาโปรแกรมด้วย Python สามารถทำได้ง่ายและรวดเร็ว ไม่ว่าจะเป็นโครงการขนาดเล็กหรือขนาดใหญ่ก็ตาม ด้วยเหตุผลเหล่านี้ Python จึงเป็นหนึ่งในภาษาโปรแกรมมิ่งที่ได้รับความนิยมอย่างสูงในหมู่นักพัฒนาและนักวิจัยทั่วโลก และยังคงเติบโตในการใช้งานอย่างกว้างขวางในอนาคต.",tabSpace: true),
